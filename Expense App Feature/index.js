...
app.post('/addexpense',(req,res)=>{
    ...
    query = "insert into addexpense (amount,description,category) values(?,?,?)";
    conn.query(query,[addexpense.amount,addexpense.description,addexpense.category],(err,results)=>{
        if(!err){
